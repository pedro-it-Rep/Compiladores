...
class Tela:
    ...
    def openFile(self):
        ...
        self.arquivo = askopenfile(mode="r", title="Select a file",
                                   filetypes=(
                                   ('All Files', '*.*'), ("Arquivos de Texto", "*.txt"), ("Arquivos Python", "*.py")))
    ...
    def saveFileAs(self):
        self.arquivo = asksaveasfile(
            filetypes=(('All Files', '*.*'), ("Arquivos de Texto", "*.txt"), ("Arquivos Python", "*.py"))).name
